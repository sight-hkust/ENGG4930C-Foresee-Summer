                    ...
                    <View style={{ height: "100%" }}>
                        <View style={{ flex: 3 }}>
                            {calDateDifference() ? (
                                <View
                                    style={
                                        OverviewScreenStyle.reminderContainer
                                    }
                                >
                                    <Icon
                                        name="error-outline"
                                        color="#24559E"
                                        containerStyle={
                                            OverviewScreenStyle.iconstyle
                                        }
                                    />
                                    <Text
                                        style={OverviewScreenStyle.reminderText}
                                    >
                        ...
                        <View style={{ flexDirection: "row", flex: 10 }}>
                            <View style={{ flex: 1, alignItems: "center" }}>
                                <View
                                    style={
                                        OverviewScreenStyle.greetingContainer
                                    }
                                >
                                    <Text
                                        style={OverviewScreenStyle.greetingText}
                                    >
                                        您好，
                                    </Text>
                                    <FamilyListPicker
                                        onSelectionUpdate={
                                            this.updateSelectedFamilyMember
                                        }
                                    />
                                </View>
                                <View
                                    style={{ flex: 2.3, alignSelf: "center" }}
                                >
                                    <View
                                        style={
                                            OverviewScreenStyle.leftEyeContainer
                                        }
                                    >
                                        <DisplayDegree
                            ...
                            >
                                <View
                                    style={
                                        OverviewScreenStyle.rightEyeContainer
                                    }
                                >
                                    <DisplayDegree
                                        data={this.state.data}
                                ...
                                <View
                                    style={
                                        OverviewScreenStyle.nextPageContainer
                                    }
                                >
                                    <Text
                                        style={OverviewScreenStyle.nextPageText}
                                    >
                                        詳細度數趨勢/{"\n"}輸入數據
                                    </Text>
                                    <Button
    ...
    if (data == null) {
        return (
            <>
                ...
                <View>
                    <Text style={OverviewScreenStyle.noRecordText}>
                        暫無數據
                    </Text>
                </View>
            </>
