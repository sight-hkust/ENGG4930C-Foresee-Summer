...
export const SchemaRecords = object({
  ...
  //   .moreThan(700, "應大於700度")
  //   .test("divisible by 25", "應以00, 25, 50或75作尾", (value) => value % 25 == 0),
  L_SPH: number().when("Slider_L_SPH", (value, schema) => (value != ">700" ? schema.lessThan(700, "應大於700度") : schema.moreThan(700, "應大於700度"))),
  R_SPH: number().when("Slider_R_SPH", (value, schema) => (value != ">700" ? schema.lessThan(700, "應大於700度") : schema.moreThan(700, "應大於700度"))),
  // R_SPH: string()
