...
export default class ProfPatientViewScreen extends Component {
    ...
    componentDidMount() {
        ...
        database.ref('professionals/M001/patients/' + key + '/records').orderByKey().on('value', (snapshot) => {
            let records = [];
            let curRecord = {};
            let curYearObject = {};
            ...
            <View style={styles.fullscreen}>
                ...
                >
                    ...
                    <View style={[styles.container, 
                                ...
                                <View style={{height: '100%'}}>
                                    ...
                                    <Grid style={{flex: 5}}>
                                        <Row>
                                            ...
                                            <Col style={styles.container}><Text style={styles.dateText}>O.D.</Text></Col>
                                            <Col style={styles.container}><Text style={styles.dateText}>O.S.</Text></Col>
                                        </Row>
                                        <Row>
                                            <Col style={styles.container}><Text style={styles.gridHeader}>SPH:</Text></Col>
                                            <Col style={styles.container}><Text style={styles.gridText}>{calSPH(false)}</Text></Col>
                                            <Col style={styles.container}><Text style={styles.gridText}>{calSPH(true)}</Text></Col>
                                        </Row>
                                        <Row>
                                            <Col style={styles.container}><Text style={styles.gridHeader}>CYL:</Text></Col>
                                            <Col style={styles.container}><Text style={styles.gridText}>{calCYL(false)}</Text></Col>
                                            <Col style={styles.container}><Text style={styles.gridText}>{calCYL(true)}</Text></Col>
                                        </Row>
                                        <Row>
                                            <Col style={styles.container}><Text style={styles.gridHeader}>AXIS:</Text></Col>
                                            <Col style={styles.container}><Text style={styles.gridText}>{calAxis(false)}</Text></Col>
                                            <Col style={styles.container}><Text style={styles.gridText}>{calAxis(true)}</Text></Col>
                                        </Row>
                                        <Row>
                                        ...
                                        <Row>
                                            ...
                                            <Col style={[styles.container, {flex: 2}]}><Text style={styles.gridText}>{curRecord.PD}mm</Text></Col>
                                        </Row>
                                        <Row>
                        ...
                        <TouchableOpacity
                            onPress={() => this.props.navigation.navigate('AddRecordScreen', {
                                isProfessional: true,
