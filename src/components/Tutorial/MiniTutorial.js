...
const AddRecordTutorialContent = [
    ...
    },
    {
        subject: "詳細輸入（非必填）",
        content:
            "您可以按一下收疊式按扭，並輸入更詳細數據。記錄更多以便日後查閱。",
                            ...
                            return (
                                ...
                                >
                                    <View style={recordStyle.slide}>
                                        <Text style={recordStyle.title}>
                                            {item.subject}
                                        </Text>
                                        <Image
                                            style={recordStyle.image}
                                            source={item.image}
                                        />
                                        <Text style={recordStyle.content}>
                                            {item.content}
                                        </Text>
                                    </View>
                                </ScrollView>
                        ...
                        <ScrollView style={{ paddingHorizontal: 20 }}>
                            ...
                            <Text style={{ ...addRecordStyle.title }}>
                                ...
                                <Text style={addRecordStyle.content}>
                                    {" "}
                                    (Pupillary
                                    Distance)：兩眼瞳孔距離(單位是mm(公釐))
                                    [1公分 = 10公釐]。一般PD約為60 ~ 65mm之間。
                                </Text>
                            </Text>
                        </ScrollView>
                    </View>
