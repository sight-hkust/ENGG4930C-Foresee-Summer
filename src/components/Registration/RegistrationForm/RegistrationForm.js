...
const FormDetails = ({
    ...
    const [
        ...
        setFamilySearchFieldVisibility,
    ] = useState(false);
    const [
                        ...
                        {registerPatient ? (
                            <>
                                ...
                                {isFamilySearchFieldVisible && (
                                    <View>
                                        <TouchableOpacity
                                            onPress={_showFamilySearchDialog}
                                        >
                                            <Text
                                                style={{
                                                    backgroundColor:
                        ...
                        <Dialog.Content>
                            {roleList.map((data) => (
                                <List.Item
                                    key={data.key}
                                    title={data.label}
                                    onPress={handleRoleDialogOption.bind(
                                        this,
                                        data.value
                                    )}
                                />
                        ...
                        <Dialog.Content>
                            {partList.map((data) => (
                                <List.Item
                                    key={data.key}
                                    title={data.label}
                                    onPress={handlePartDialogOption.bind(
                                        this,
                                        data.value
                                    )}
                                />
