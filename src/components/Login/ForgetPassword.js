  ...
  return (
    <LinearGradientBackground>
      <View style={{ justifyContent: "center", alignItems: "center", flex: 1 }}>
        {!sendMailSuccess ? (
          <>
            <Text style={styles.title}> 請輸入電郵地址並重新設定 </Text>
            <InputTextField
              label="電子郵箱地址 ： "
              icon={MailIcon}
          ...
          <>
            <Icon size={40} type="material-icon" name="done" color="rgb(146, 255, 177)" containerStyle={{ borderWidth: 4, borderRadius: 100, borderColor: "rgb(146, 255, 177)", marginBottom: hp("2%") }} />
