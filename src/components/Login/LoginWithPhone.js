                ...
                <KeyboardAvoidingView behavior={"position"}>
                    <View style={styles.content}>
                        ...
                        >
                            ...
                            <RoundButton title={i18n.t('login3')} onPress={handleVerification}/>
                        </View>
                        <View style={styles.registrationNav}>
                            <Text style={styles.registrationNavText}>{i18n.t('login4')}</Text>
                            <TouchableOpacity
                                onPress={() => {
                                    navigation.navigate("Register");
                                }}
                            >
                                <Text style={[styles.registrationNavText, {color: "#FFFFFF"}]}>{i18n.t('login5')}</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
                </KeyboardAvoidingView>
            </LinearGradientBackground>
            <Modal isVisible={isVerficationModalShown} animationIn={"fadeIn"} animationOut={"fadeOut"}
                   backdropOpacity={0.5} onBackdropPress={() => setVerifcationModalState(false)}>
                <VerificationInput confirmationResult={confirmationResult}
