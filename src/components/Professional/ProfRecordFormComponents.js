    ...
    return (
        <>
            <SPHInput
                ...
                mode="normal"
            />
            {error_R_SPH != undefined && (
                <Text style={FormItemStyle.errortext}>{error_R_SPH}</Text>
            )}
            <CYLInput
                setFieldValue={setFieldValue}
                isLeft={false}
                mode="normal"
                error_CYL={error_R_CYL}
                error_Axis={error_R_Axis}
            />
            <PRISMInput
                setFieldValue={setFieldValue}
                isLeft={false}
            ...
            <SPHInput
                ...
                mode="normal"
            />
            {error_L_SPH != undefined && (
                <Text style={FormItemStyle.errortext}>{error_L_SPH}</Text>
            )}
            <CYLInput
                setFieldValue={setFieldValue}
                isLeft={true}
                mode="normal"
                error_CYL={error_L_CYL}
                error_Axis={error_L_Axis}
            />
            <PRISMInput
                setFieldValue={setFieldValue}
                isLeft={true}
        ...
        <View>
            ...
            <Collapsible collapsed={isCollapse}>
                <View style={FormItemStyle.collpaseContainer}>
                    ...
                    <TextInput
                        onChangeText={(value) => setFieldValue("VA", value)}
...
export const BrandInput = (props) => {
    ...
    return (
        <View>
            ...
            <TextInput
                onChangeText={handleChange("Con_brand")}
                multiline={true}
...
export const BCInput = (props) => {
    ...
    return (
        <View style={{ alignSelf: "center" }}>
            <Text style={FormItemStyle.questionText}>
                請輸入{isLeft ? "左眼的(O.S.)" : "右眼的(O.D.)"}隱形眼鏡弧度(BC)
            </Text>
            <TextInput
                onChangeText={TextinputHandler}
                keyboardType="numeric"
...
export const ADDInput = (props) => {
    ...
    return (
        <View style={{ alignSelf: "center" }}>
            {QuestionText()}
            <View
                style={{ flexDirection: "row", paddingLeft: 5, paddingTop: 10 }}
            >
                <Text
...
export const SPHInput = (props) => {
    ...
    const RadioButtonHandler = (value) => {
        ...
        switch (mode) {
            ...
            case "con":
                setFieldValue(
                    isLeft ? "Con_L_symbol" : "Con_R_symbol",
                    value,
                    false
                );
                break;
            case "far":
                setFieldValue(
                    isLeft ? "Far_L_symbol" : "Far_R_symbol",
                    value,
                    false
                );
                break;
            case "mid":
                setFieldValue(
                    isLeft ? "Mid_L_symbol" : "Mid_R_symbol",
                    value,
                    false
                );
                break;
            case "near":
                setFieldValue(
                    isLeft ? "Near_L_symbol" : "Near_R_symbol",
                    value,
                    false
                );
                break;
...
export const CYLInput = (props) => {
    ...
    return (
        <View style={{ alignSelf: "center" }}>
            ...
            {error_CYL != undefined && (
                <Text style={FormItemStyle.errortext}>{error_CYL}</Text>
            )}
...
export const AxisInput = (props) => {
    ...
    return (
        <View style={{ alignSelf: "center" }}>
            ...
            />
            {error != undefined && (
                <Text style={FormItemStyle.errortext}>{error}</Text>
            )}
        </View>
    );
};
