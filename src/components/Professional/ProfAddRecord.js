                        ...
                        onSubmit={(values) => {
                            ...
                            if (isProfessional) {
                                ...
                                if (!exist) {
                                    ...
                                    Alert.alert(
                                        i18n.t('profAdd1'),
                                        i18n.t('profAdd2') + values.date + i18n.t('profAdd3'),
                                        [
                                            {text: i18n.t('profAdd4'), style: "cancel"},
                                            {
                                                text: i18n.t('profAdd5'),
                                                onPress: () => {
                    ...
                    >
                        {({handleSubmit, values, setFieldValue, handleChange, errors}) => (
                            <View style={AddRecordScreen.formContainer}>
                                ...
                                <RenderCollapseVA setFieldValue={setFieldValue} error_L_VA={errors.L_VA}
                                                  error_R_VA={errors.R_VA}/>
                                <RenderCollapsePD handleChange={handleChange} error_L_PD={errors.L_PD}
                                ...
                                <View style={{paddingTop: 24}}>
                                    ...
                                    <Text style={AddRecordScreen.errorMsg}>{i18n.t('profAdd6')}</Text>}
                                    <Button
                                        title={i18n.t('ok')}
