...
export default class Form extends Component {
    ...
    render() {
        const {
            ...
            professional_id,
            patient_id,
        } = this.props.route.params; //noneed to consider "inactive"
        return (
            <MenuScreen>
                <ScrollView
                ...
                >
                    <Formik
                        ...
                        onSubmit={(values) => {
                            ...
                            if (values.Adj_L_symbol)
                                data.Adj_L_Hyperopia = parseInt(
                                    values.Adj_L_SPH
                                );
                            else data.Adj_L_Myopia = parseInt(values.Adj_L_SPH);
                            if (values.Adj_R_symbol)
                                data.Adj_R_Hyperopia = parseInt(
                                    values.Adj_R_SPH
                                );
                            ...
                            if (values.Con_L_symbol)
                                data.Con_L_Hyperopia = parseInt(
                                    values.Con_L_SPH
                                );
                            else data.Con_L_Myopia = parseInt(values.Con_L_SPH);
                            if (values.Con_R_symbol)
                                data.Con_R_Hyperopia = parseInt(
                                    values.Con_R_SPH
                                );
                            ...
                            if (values.Far_L_symbol)
                                data.Far_L_Hyperopia = parseInt(
                                    values.Far_L_SPH
                                );
                            else data.Far_L_Myopia = parseInt(values.Far_L_SPH);
                            if (values.Far_R_symbol)
                                data.Far_R_Hyperopia = parseInt(
                                    values.Far_R_SPH
                                );
                            ...
                            if (values.Mid_L_symbol)
                                data.Mid_L_Hyperopia = parseInt(
                                    values.Mid_L_SPH
                                );
                            else data.Mid_L_Myopia = parseInt(values.Mid_L_SPH);
                            if (values.Mid_R_symbol)
                                data.Mid_R_Hyperopia = parseInt(
                                    values.Mid_R_SPH
                                );
                            ...
                            if (values.Near_L_symbol)
                                data.Near_L_Hyperopia = parseInt(
                                    values.Near_L_SPH
                                );
                            else
                                data.Near_L_Myopia = parseInt(
                                    values.Near_L_SPH
                                );
                            if (values.Near_R_symbol)
                                data.Near_R_Hyperopia = parseInt(
                                    values.Near_R_SPH
                                );
                            else
                                data.Near_R_Myopia = parseInt(
                                    values.Near_R_SPH
                                );
                    ...
                    >
                        {({
                            ...
                            <View style={AddRecordScreen.formContainer}>
                                ...
                                <RenderCollapseVA
                                    setFieldValue={setFieldValue}
                                    error_L_VA={errors.L_VA}
                                    error_R_VA={errors.R_VA}
                                />
                                <RenderCollapsePD
                                    handleChange={handleChange}
                                    error_L_PD={errors.L_PD}
                                    error_R_PD={errors.R_PD}
                                />
