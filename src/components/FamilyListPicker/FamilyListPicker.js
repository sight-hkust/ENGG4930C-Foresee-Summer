        ...
        <>
            ...
            >
                {selectedFamilyMember && (
                    <>
                        <Text
                            style={[selectedFamilyMember.lastName != "" ? FamilyListPickerStyle.userNameChinese : FamilyListPickerStyle.userNameEnglish, textStyle]}>{displayName(selectedFamilyMember)}</Text>
                        <View
                            style={{
                        ...
                        >
                            <Icon name="caretdown" type="antdesign" size={ScreenWidth * 0.05}
            ...
            <Portal>
                <Modal visible={isFamilyListModalVisible} onDismiss={_hideFamilyListModal}>
                    ...
                    >
                        <Text style={{fontSize: 23}}>{i18n.t('familyList1')}</Text>
                        <FlatList
                            data={familyMembers}
