...
const PRIVACY_POLICY = `
    ...
    <p>
        Sight built the Foresee app as
        a Free app. This SERVICE is provided by
        Sight at no cost and is intended for use as
        is.
    </p> <p>
        ...
        Foresee unless otherwise defined in this Privacy Policy.
        ...
        this page.
    </p> <p>This policy is effective as of 2020-06-30</p> <p><strong>Contact Us</strong></p> <p>
        If you have any questions or suggestions about our
        Privacy Policy, do not hesitate to contact us at foresee@ust.hk.
    </p> <p>
...
export default function PrivacyPolicy() {
  return (
    <MenuScreen>
      <ScrollView style={{ width: ScreenWidth, height: ScreenHeight * 0.8, marginTop: 30 }}>
        <WebView originWhitelist={['*']} source={{ html: PRIVACY_POLICY }} />
      </ScrollView>
    </MenuScreen>
  );
}
