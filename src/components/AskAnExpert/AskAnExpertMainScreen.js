...
export const HotQuestionCard = (props) => {
    ...
    return (
        <View
            style={{ ...styles.shadow, ...{ paddingHorizontal: wp("2.3%") } }}
        >
            <Surface style={{ ...{ elevation: 12, borderRadius: 31 } }}>
                <View style={styles.hotTopicCard}>
                    ...
                    >
                        <LinearGradientBackground
                            colors={[
                                `rgb(${RGB[0] + (props.counter % 4) * 12},${
                                    RGB[1] + (props.counter % 4) * 36
                                }, ${RGB[2] + (props.counter % 4) * 28})`,
                                `rgb(${
                                    RGB[0] + ((props.counter % 4) + 1) * 12
                                },${RGB[1] + ((props.counter % 4) + 1) * 36}, ${
                                    RGB[2] + ((props.counter % 4) + 1) * 28
                                })`,
                            ]}
                            start={[0, 1]}
                            end={[1, 0]}
                        ...
                        >
                            <Text style={styles.hotTopicCardText}>
                                {props.faq.question_title.length <= 14
                                    ? props.faq.question_title
                                    : props.faq.question_title.substring(
                                          0,
                                          14
                                      ) + "..."}
                            </Text>
