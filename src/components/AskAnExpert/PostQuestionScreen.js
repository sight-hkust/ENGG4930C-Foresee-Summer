...
const PostQuestionScreen = ({ route, navigation }) => {
    ...
    <View style={styles.container}>
        <Text style={{fontSize: 30, color: 'white', alignSelf: 'baseline', left: 30, marginBottom: ScreenHeight * 0.03 }}>
            撰寫問題
        </Text>
        { !isSubmitted? 
        <Formik
            ...
            onSubmit={values => {
                if(values.title.length !=0 && values.content.length != 0) {
                    database.ref('contents/askProf/' + values.title)
                        .set({
        ...
        { formikProps => (
            <View style={styles.form}>
                ...
                <Input
                    ...
                    rightIcon={
                        <Text style={styles.wordCounter}>{formikProps.values.title.length}/20</Text>
                    }
                ...
                <Input
                    ...
                    rightIcon={
                        <Text style={styles.wordCounter}>{formikProps.values.content.length}/200</Text>
                    }
                ...
                <CheckBox 
                    ...
                    containerStyle={{backgroundColor: 'transparent', borderColor: 'transparent', paddingBottom: 100}}
        ...
        :
        <View style={{justifyContent: 'center', height: ScreenHeight * 0.6, width: ScreenWidth * 0.82, top: 60}}>
