                            ...
                            {articles.map((item) => {
                                return (
                                    <ProgressView
                                        key={item["_uid"]}
                                        articles={item}
                                        userScore={userArticleScoreList}
...
const ProgressView = (props) => {
    const [userData, setUserData] = useState(
        props.userScore[0][props.articles["_uid"]]
    );
    ...
    return (
        ...
        >
            <View style={{ marginBottom: hp("4%"), width: "60%" }}>
                <View
                    style={{ flexDirection: "row", marginBottom: hp("1.5%") }}
                >
                    <Icon
            ...
            <Button
                ...
                onPress={() => {
                    props.navigation.navigate("ArticleDetailScreen", {
                        article_id: props.articles["_uid"],
                    });
                }}
            />
        </View>
