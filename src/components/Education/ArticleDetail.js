...
export default class ArticleDetailScreen extends Component {
    ...
    componentDidMount() {
        ...
        database
            .ref(`contents/articles/${this.state.article_id}`)
            .once("value", (snapshot) => {
    ...
    async componentWillUnmount() {
        ...
        database
            ...
            .once("value", (snapshot) => {
                ...
                database
                    .ref(
                        `contents/articles/${this.state.article_id}/viewRecords/${views}`
                    )
                    .update({
                    ...
                    {!this.state.isVid && (
                        <>
                            ...
                            <View style={{ marginTop: ScreenWidth * 0.45 }}>
                                <Text
                                    style={[ArticleDetailStyles.articleSubject]}
                                >
                                    {this.state.subject}
                                </Text>
                            </View>
